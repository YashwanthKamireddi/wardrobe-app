        ...
        {moodTypes.map((mood) => (
          <Button
            ...
            className={cn(
              ...
              selectedMood === mood.value && "bg-gradient-to-br shadow-md"
            )}
            onClick={() => setSelectedMood(mood.value)}
            style={{
              background: selectedMood === mood.value 
                ? `linear-gradient(to bottom right, var(--${mood.value}-gradient-from), var(--${mood.value}-gradient-to))` 
                : undefined
            }}
          >
            <div className={cn(
